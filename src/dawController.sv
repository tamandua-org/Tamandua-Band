                    ...
                    case (current_mode)
                        MODE_NORMAL: begin
                            case (active_scancode)
                                ...
                                // pattern selection (keys 1 to 0)
                                8'h16: ui_active_pattern <= 4'd0; // 1
                                8'h1E: ui_active_pattern <= 4'd1; // 2
                                8'h26: ui_active_pattern <= 4'd2; // 3
                                8'h25: ui_active_pattern <= 4'd3; // 4
                                8'h2E: ui_active_pattern <= 4'd4; // 5
                                8'h36: ui_active_pattern <= 4'd5; // 6
                                8'h3D: ui_active_pattern <= 4'd6; // 7
                                8'h3E: ui_active_pattern <= 4'd7; // 8
                                8'h46: ui_active_pattern <= 4'd8; // 9
