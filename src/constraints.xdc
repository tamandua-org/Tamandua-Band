...
set_property -dict { PACKAGE_PIN L2 IOSTANDARD LVCMOS33 } [get_ports sclk] # serial clk
set_property -dict { PACKAGE_PIN J2 IOSTANDARD LVCMOS33 } [get_ports lrclk] # left (low)/right (high) clock stereo
set_property -dict { PACKAGE_PIN H1 IOSTANDARD LVCMOS33 } [get_ports sdata] # serial data
